...
public class FirstFragment extends Fragment {
    ...
    private OnNewTextAddedListener listener;
    ...
    private void onAddButtonClicked() {
        listener.onTextAdded(this.editText.getText().toString());
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof OnNewTextAddedListener) {
            listener = (OnNewTextAddedListener) context;
        } else {
            throw new ClassCastException(context.toString()
                    + " must implement FirstFragment.OnItemSelectedListener");
        }
    }

    // TODO 09. We can just add a new method to the fragment class
    public void clearAll() {
        this.textCountLabel.setText(getResources().getString(R.string.text_added_value));
    }
    ...
    public interface OnNewTextAddedListener {
